...
| `--profile` | `spec` | rule profile: `spec` (the specification), `tuned` (spec with four rules relaxed on replay evidence) or `legacy` (rules until 2026-09-05). The nightly job currently runs `legacy`; see the tuning page. |
